...
class LucioUtils {
	...
	const LUCIO_CONCEPTO_GASTO_VARIOS = 1;

	const LUCIO_CONCEPTO_MOVIMIENTO_GASTO= 2;
	const LUCIO_CONCEPTO_MOVIMIENTO_ANULACIONGASTO= 3;
	const LUCIO_CONCEPTO_MOVIMIENTO_VENTA= 4;
	const LUCIO_CONCEPTO_MOVIMIENTO_ANULACIONVENTA= 5;
	const LUCIO_CONCEPTO_MOVIMIENTO_PAGO= 6;
	const LUCIO_CONCEPTO_MOVIMIENTO_DEVOLUCION= 7;
	const LUCIO_CONCEPTO_MOVIMIENTO_ACTUALIZACION= 8;
	const LUCIO_CONCEPTO_MOVIMIENTO_PEDIDO= 9;
	...
	const LUCIO_CAJA_DEFAULT = 1;

	const LUCIO_CLIENTE_DEFAULT = 1;

	const LUCIO_PROVEEDOR_DEFAULT = 1;

	const LUCIO_ID_DOLAR = 1;
	const LUCIO_ID_PORCENTAJE_PRECIO_LISTA = 2;

	const LUCIO_TIPO_PRODUCTO_DEFAULT = 21;
	const LUCIO_MARCA_PRODUCTO_DEFAULT = 24;
	...
	public static function sendMailPop($nameTo, $to, $subject, $msg, $attachs) {
		...
		/*$libsHome= LucioConfig::getInstance()->getLibsPath();
		...
		if( LucioConfig::TEST_MODE ){
			//me los envÃ­o todos a mi en test
			$to = LucioConfig::TEST_MAIL_TO;
		}
		...
		$mail->Host = LucioConfig::POP_MAIL_HOST;
		//Set the SMTP port number - likely to be 25, 465 or 587
		$mail->Port = LucioConfig::POP_MAIL_PORT;
		$mail->SMTPSecure = LucioConfig::POP_MAIL_SMTP_SECURE;
		//Whether to use SMTP authentication
		$mail->SMTPAuth = true;
		//Username to use for SMTP authentication
		$mail->Username = LucioConfig::POP_MAIL_USERNAME;
		//Password to use for SMTP authentication
		$mail->Password = LucioConfig::POP_MAIL_PASSWORD;

		//Set who the message is to be sent from
		$mail->setFrom(LucioConfig::MAIL_FROM, LucioConfig::MAIL_FROM_NAME);
		//Set an alternative reply-to address
		$mail->addReplyTo(LucioConfig::MAIL_FROM, LucioConfig::MAIL_FROM_NAME);
	...
	public static function getConceptoGastoVarios(){
		...
		return ServiceFactory::getConceptoGastoService()->get( self::LUCIO_CONCEPTO_GASTO_VARIOS );
	}

	public static function getConceptoMovimientoGasto(){

		return ServiceFactory::getConceptoMovimientoService()->get( self::LUCIO_CONCEPTO_MOVIMIENTO_GASTO );
	}

	public static function getConceptoMovimientoAnulacionGasto(){

		return ServiceFactory::getConceptoMovimientoService()->get( self::LUCIO_CONCEPTO_MOVIMIENTO_ANULACIONGASTO );
	}

	public static function getConceptoMovimientoPedido(){

		return ServiceFactory::getConceptoMovimientoService()->get( self::LUCIO_CONCEPTO_MOVIMIENTO_PEDIDO );
	}

	public static function getConceptoMovimientoAnulacionPedido(){

		return ServiceFactory::getConceptoMovimientoService()->get( self::LUCIO_CONCEPTO_MOVIMIENTO_ANULACIONPEDIDO );
	}

	public static function getConceptoMovimientoVenta(){

		return ServiceFactory::getConceptoMovimientoService()->get( self::LUCIO_CONCEPTO_MOVIMIENTO_VENTA );
	}

	public static function getConceptoMovimientoAnulacionVenta(){

		return ServiceFactory::getConceptoMovimientoService()->get( self::LUCIO_CONCEPTO_MOVIMIENTO_ANULACIONVENTA );
	}

	public static function getConceptoMovimientoPago(){

		return ServiceFactory::getConceptoMovimientoService()->get( self::LUCIO_CONCEPTO_MOVIMIENTO_PAGO);
	}

	public static function getConceptoMovimientoDevolucion(){

		return ServiceFactory::getConceptoMovimientoService()->get( self::LUCIO_CONCEPTO_MOVIMIENTO_DEVOLUCION);
	}
	...
	public static function getCuentaUnica(){
		...
		return ServiceFactory::getCuentaService()->get( self::LUCIO_CUENTA_UNICA );
	}

	public static function getCajaDeafault(){

		return ServiceFactory::getCajaService()->get( self::LUCIO_CAJA_DEFAULT );
	}

	public static function getPrecioDolar(){

		return ServiceFactory::getParametroService()->get( self::LUCIO_ID_DOLAR );
	}

	public static function getPorcentajePrecioLista(){

		return ServiceFactory::getParametroService()->get( self::LUCIO_ID_PORCENTAJE_PRECIO_LISTA );
	}

	public static function getTipoProductoDefault(){

		return ServiceFactory::getTipoProductoService()->get( self::LUCIO_TIPO_PRODUCTO_DEFAULT );
	}

	public static function getMarcaProductoDefault(){

		return ServiceFactory::getMarcaProductoService()->get( self::LUCIO_MARCA_PRODUCTO_DEFAULT );
	}

	public static function getClienteDefault(){

		return ServiceFactory::getClienteService()->get( self::LUCIO_CLIENTE_DEFAULT );
	}

	public static function getProveedorDefault(){

		return ServiceFactory::getProveedorService()->get( self::LUCIO_PROVEEDOR_DEFAULT );
	}
}
