...
use Lucio\Core\dao\IMovimientoCajaDAO;

use Lucio\Core\dao\IMovimientoVentaDAO;

use Lucio\Core\model\MovimientoVenta;

use Lucio\Core\model\ConceptoMovimiento;

use Lucio\Core\dao\IConceptoMovimientoDAO;
...
class MovimientoCajaDoctrineDAO extends CrudDAO implements IMovimientoCajaDAO{
	...
	protected function getClazz(){
		return "Lucio\Core\model\MovimientoCaja";
	}
