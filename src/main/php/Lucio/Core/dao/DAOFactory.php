...
use Lucio\Core\dao\impl\PaisDoctrineDAO;
use Lucio\Core\dao\impl\MarcaProductoDoctrineDAO;
use Lucio\Core\dao\impl\IvaDoctrineDAO;
use Lucio\Core\dao\impl\TipoProductoDoctrineDAO;




use Lucio\Core\dao\impl\ProvinciaDoctrineDAO;
use Lucio\Core\dao\impl\LocalidadDoctrineDAO;
use Lucio\Core\dao\impl\ClienteDoctrineDAO;

use Lucio\Core\dao\impl\ProveedorDoctrineDAO;
use Lucio\Core\dao\impl\CompaniaDoctrineDAO;

use Lucio\Core\dao\impl\ConceptoGastoDoctrineDAO;
use Lucio\Core\dao\impl\ConceptoMovimientoDoctrineDAO;
use Lucio\Core\dao\impl\ProductoDoctrineDAO;

use Lucio\Core\dao\impl\AnulacionDoctrineDAO;


use Lucio\Core\dao\impl\GastoDoctrineDAO;
use Lucio\Core\dao\impl\CuentaDoctrineDAO;
use Lucio\Core\dao\impl\MovimientoGastoDoctrineDAO;
use Lucio\Core\dao\impl\MovimientoCajaDoctrineDAO;
use Lucio\Core\dao\impl\VentaDoctrineDAO;
use Lucio\Core\dao\impl\MovimientoVentaDoctrineDAO;
use Lucio\Core\dao\impl\CuentaCorrienteDoctrineDAO;
use Lucio\Core\dao\impl\BancoDoctrineDAO;
use Lucio\Core\dao\impl\CajaDoctrineDAO;
use Lucio\Core\dao\impl\PagoDoctrineDAO;
use Lucio\Core\dao\impl\MovimientoPagoDoctrineDAO;
use Lucio\Core\dao\impl\MovimientoPedidoDoctrineDAO;
use Lucio\Core\dao\impl\TarjetaDoctrineDAO;

use Lucio\Core\dao\impl\ParametroDoctrineDAO;



use Lucio\Core\dao\impl\PresupuestoDoctrineDAO;

use Lucio\Core\dao\impl\ComboDoctrineDAO;

use Lucio\Core\dao\impl\ActualizacionDoctrineDAO;

use Lucio\Core\dao\impl\MovimientoActualizacionDoctrineDAO;

use Lucio\Core\dao\impl\PedidoDoctrineDAO;
...
class DAOFactory {
     ...
     * @return ICompania
     */
    public static function getCompaniaDAO(){

        return new CompaniaDoctrineDAO();
    }
