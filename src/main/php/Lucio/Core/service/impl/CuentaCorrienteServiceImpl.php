...
use Lucio\Core\model\MovimientoPago;

use Lucio\Core\model\MovimientoActualizacion;
...
use Lucio\Core\service\ICuentaCorrienteService;
...
//		DAOFactory::getClienteDAO()->update( $cliente );
	...
	/**
	 * (non-PHPdoc)
	 * @see src/main/php/Lucio/Core/service/Lucio\Core\service.ICuentaCorrienteService::getTotalesVenta()
	 */
	...
	/**
	 * (non-PHPdoc)
	 * @see src/main/php/Lucio/Core/service/Lucio\Core\service.ICuentaCorrienteService::getTotalesPago()
	 */
	...
	/**
	 * (non-PHPdoc)
	 * @see src/main/php/Lucio/Core/service/Lucio\Core\service.ICuentaCorrienteService::cobrarDeuda()
	 */
	public function cobrarDeuda(Cliente $cliente, Cuenta $destino, $monto, $observaciones, User $user){
		...
		$movimiento->setConcepto( LucioUtils::getConceptoMovimientoPago() );
	...
	/**
	 * (non-PHPdoc)
	 * @see src/main/php/Lucio/Core/service/Lucio\Core\service.ICuentaCorrienteService::actualizarDeuda()
	 */
	public function actualizarDeuda(Cliente $cliente, Cuenta $destino, $monto, $observaciones, User $user){
		...
		$movimiento->setConcepto( LucioUtils::getConceptoMovimientoActualizacion() );
		$movimiento->setUser($user);
