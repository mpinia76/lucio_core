...
use Lucio\Core\model\MovimientoGasto;
...
use Lucio\Core\service\IGastoService;
...
class GastoServiceImpl extends CrudService implements IGastoService {
	...
	/**
	 * (non-PHPdoc)
	 * @see src/main/php/Lucio/Core/service/Lucio\Core\service.IGastoService::pagar()
	 */
	public function pagar(Gasto $gasto, Cuenta $cuenta, User $user){
		...
		$movimiento->setConcepto( LucioUtils::getConceptoMovimientoGasto() );
	...
	/**
	 * (non-PHPdoc)
	 * @see src/main/php/Lucio/Core/service/Lucio\Core\service.IGastoService::anular()
	 */
	public function anular(Gasto $gasto, User $user){
		...
		if( $gasto->getEstado() == EstadoGasto::Pagado ){
			...
			$contramovimiento->setConcepto( LucioUtils::getConceptoMovimientoAnulacionGasto() );
	...
	/**
	 * (non-PHPdoc)
	 * @see src/main/php/Lucio/Core/service/Lucio\Core\service.IGastoService::getGastosPorVencer()
	 */
