...
use Lucio\Core\model\MovimientoPedido;
...
use Lucio\Core\service\IPedidoService;
...
class PedidoServiceImpl extends CrudService implements IPedidoService {
	...
	/**
	 * (non-PHPdoc)
	 * @see src/main/php/Lucio/Core/service/Lucio\Core\service.IPedidoService::pagar()
	 */
	public function pagar(Pedido $pedido, Cuenta $cuenta, User $user){
		...
		$movimiento->setConcepto( LucioUtils::getConceptoMovimientoPedido() );
	...
	/**
	 * (non-PHPdoc)
	 * @see src/main/php/Lucio/Core/service/Lucio\Core\service.IPedidoService::anular()
	 */
	public function anular(Pedido $pedido, User $user){
		...
		if( $pedido->getEstado() == EstadoPedido::Pagado ){
			...
			$contramovimiento->setConcepto( LucioUtils::getConceptoMovimientoAnulacionPedido() );
	...
	/**
	 * (non-PHPdoc)
	 * @see src/main/php/Lucio/Core/service/Lucio\Core\service.IPedidoService::recibir()
	 */
	...
	/**
	 * (non-PHPdoc)
	 * @see src/main/php/Lucio/Core/service/Lucio\Core\service.IPedidoService::anularRecibir()
	 */
