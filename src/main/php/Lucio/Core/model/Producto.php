 ...
 * Producto
 *
 * @Entity @Table(name="lucio_producto")
 *
 * @author Marcos
 */
...
class Producto extends Entity{
    ...
    /**
     * @ManyToOne(targetEntity="Lucio\Core\model\TipoProducto",cascade={"detach"})
    ...
    /**
     * @ManyToOne(targetEntity="Lucio\Core\model\MarcaProducto",cascade={"detach"})
	...
	private $descripcion;
	 ...
	 /**
     * @ManyToOne(targetEntity="Lucio\Core\model\Iva",cascade={"detach"})
	...
	{
		/*$parametroDolar = LucioUtils::getPrecioDolar();
	    $parametroPorcentaje = LucioUtils::getPorcentajePrecioLista();
