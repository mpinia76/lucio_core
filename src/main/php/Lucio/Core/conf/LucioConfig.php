...
class LucioConfig {
	...
	private $appPathCore = "D:/Documents/Mis Webs/lucio_core";

	const PROXIES_NAMESPACE="lucio\\Core\\Proxies";
	const PROXIES_PATH=  "/Proxies";


	const TEST_MODE = true;
	const MAIL_FROM_NAME = "Lucio Tanto";
	const MAIL_FROM = "luciotanto@gmail.com";
