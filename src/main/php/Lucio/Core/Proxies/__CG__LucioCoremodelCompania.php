 ...
 */
class Compania extends \Lucio\Core\model\Compania implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Lucio\\Core\\model\\Compania' . "\0" . 'nombre', '' . "\0" . 'Lucio\\Core\\model\\Compania' . "\0" . 'tipoDocumento', '' . "\0" . 'Lucio\\Core\\model\\Compania' . "\0" . 'documento', '' . "\0" . 'Lucio\\Core\\model\\Compania' . "\0" . 'cbu', '' . "\0" . 'Lucio\\Core\\model\\Compania' . "\0" . 'razonSocial', '' . "\0" . 'Lucio\\Core\\model\\Compania' . "\0" . 'cuit', '' . "\0" . 'Lucio\\Core\\model\\Compania' . "\0" . 'condicionIva', '' . "\0" . 'Lucio\\Core\\model\\Compania' . "\0" . 'sexo', '' . "\0" . 'Lucio\\Core\\model\\Compania' . "\0" . 'mail', '' . "\0" . 'Lucio\\Core\\model\\Compania' . "\0" . 'telefono', '' . "\0" . 'Lucio\\Core\\model\\Compania' . "\0" . 'celular', '' . "\0" . 'Lucio\\Core\\model\\Compania' . "\0" . 'laboral', '' . "\0" . 'Lucio\\Core\\model\\Compania' . "\0" . 'localidad', '' . "\0" . 'Lucio\\Core\\model\\Compania' . "\0" . 'direccion', '' . "\0" . 'Lucio\\Core\\model\\Compania' . "\0" . 'nacimiento', '' . "\0" . 'Lucio\\Core\\model\\Compania' . "\0" . 'fecha', '' . "\0" . 'Lucio\\Core\\model\\Compania' . "\0" . 'ultModificacion', '' . "\0" . 'Lucio\\Core\\model\\Compania' . "\0" . 'observaciones', '' . "\0" . 'Lucio\\Core\\model\\Compania' . "\0" . 'cuentaCorriente'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Compania $proxy) {
