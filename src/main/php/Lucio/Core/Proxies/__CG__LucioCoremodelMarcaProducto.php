 ...
 */
class MarcaProducto extends \Lucio\Core\model\MarcaProducto implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Lucio\\Core\\model\\MarcaProducto' . "\0" . 'nombre'];
        }
