 ...
 */
class TipoProducto extends \Lucio\Core\model\TipoProducto implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Lucio\\Core\\model\\TipoProducto' . "\0" . 'nombre'];
        }
